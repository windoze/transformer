...
f_trip_time_rounded_with_unsupported_func = DerivedFeature(name="f_trip_time_rounded",
                                        feature_type=INT32,
                                        input_features=[f_trip_time_duration],
                                        transform="f_trip_time_duration % 10 + xpath_int(\"/a/b/c\")")
...
dsl=dsl_generator.gen_dsl("test_pipeline", [f_day_of_week])
print(dsl)

# This will fail because it uses unsupported function `xpath_int`
dsl = dsl_generator.gen_dsl("test_pipeline", [f_trip_time_rounded_with_unsupported_func])
print(dsl)

# This will fail because we don't support WindowAggTransformation
dsl =dsl_generator.gen_dsl("test_pipeline", [f_location_avg_fare])
print(dsl)
